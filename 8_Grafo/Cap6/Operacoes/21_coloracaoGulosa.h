#ifndef COLORACAOGULOSA_H_INCLUDED
#define COLORACAOGULOSA_H_INCLUDED
// listas separadas para cada cor
// começar em dado vertice
// analisar cada lista para verificar se é possível inserir o vértice
// Eu queria colocar o parametro vertice inicial na função coloracaoGulosa, mas eu tenho que fazer o projeto final de poo em três dias
...
// acredito que eu possa usar buscarVertice aqui, mas sla
    return false;
}
void coloracaoGulosa(pDGrafo grafo, int numCores)
{
...
#endif // 21_COLORACAOGULOSA_H_INCLUDED
